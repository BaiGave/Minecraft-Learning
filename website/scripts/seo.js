...
function generateSitemapFromContent(options = {}) {
    ...
    const staticPages = [
        ...
        { url: '/website/index.html', priority: '0.9', changefreq: 'weekly' },
        { url: '/website/catalog.html', priority: '0.8', changefreq: 'weekly' },
        { url: '/website/roadmap.html', priority: '0.7', changefreq: 'weekly' },
        { url: '/website/about.html', priority: '0.6', changefreq: 'monthly' }
    ];
    ...
    // Module pages
    const modulePages = [
        { url: '/website/docs/mc/index.html', priority: '0.8', changefreq: 'weekly' },
        { url: '/website/docs/iris/index.html', priority: '0.8', changefreq: 'weekly' },
        { url: '/website/docs/sodium/index.html', priority: '0.8', changefreq: 'weekly' }
    ];
    ...
    versions.forEach(version => {
        pages.push({
            url: `/website/docs/mc/${version}/index.html`,
            priority: '0.7',
            changefreq: 'weekly'
        });
    });
