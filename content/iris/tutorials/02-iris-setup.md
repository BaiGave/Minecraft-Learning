...
# 切换到特定版本（例如 1.7.3�?git checkout v1.7.3
```
...
�?      �?  ├── pipeline/        # 渲染管线
�?      �?  ├── shaderpack/      # 着色器包系�?�?      �?  ├── shadows/         # 阴影系统
�?      �?  ├── targets/         # 帧缓�?�?      �?  ├── uniforms/        # Uniform 管理
�?      �?  ├── gl/              # OpenGL 封装
�?      �?  └── mixin/           # Mixin 注入
�?      └── resources/
�?          └── assets/iris/     # 资源文件
├── build.gradle                 # Gradle 构建配置
├── gradle.properties           # Gradle 属�?└── settings.gradle             # 项目设置
```
...
```java
// 在关键位置设置断�?public void onShaderLoaded(ShaderPack pack) {
    // 断点可以设在这里
...
- 下一章：[创建第一�?Shader](/iris/tutorials/03-create-simple-shader/) - 开始编写代�?- [Iris GitHub](https://github.com/IrisShaders/Iris) - 官方仓库
- [Mixin 文档](https://github.com/SpongePowered/Mixin) - 字节码注入框�?
---
