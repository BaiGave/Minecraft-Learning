---
title: 第 61 章：独立服务器与整合服务器（Dedicated vs Integrated）
readingTime: 15
---

# 第 61 章：独立服务器与整合服务器（Dedicated vs Integrated）
...
- [第 56 章 服务端入门](./57-server-intro.md) - MinecraftServer 的基本概念
- [第 57 章 玩家管理](./58-player-manager.md) - PlayerManager 的详细实现
