...
flowchart TB
    subgraph EntityModelHierarchy["EntityModel 继承层次"]
        ...
        EM["EntityModel#lt;T#gt;<br/>抽象基类"]
        A["AnimalModel#lt;T#gt;<br/>动物模型（支持幼年体缩放）"]
        B["BipedEntityModel#lt;T#gt;<br/>双足生物模型"]
        Q["QuadrupedEntityModel#lt;T#gt;<br/>四足生物模型"]
        S["SinglePartEntityModel#lt;T#gt;<br/>单部件模型"]
    end
