...
- 理解什么是输入处理
- 了解 Keyboard �?Mouse 类的工作原理
- 掌握快捷键绑定（KeyBinding）系�?- 了解客户端预测的概念

## 前置知识

- 了解 Minecraft 客户端基本结构（�?5章）
- 知道什么是键盘、鼠标事�?- 了解 GUI 系统基础（第47章）
...
想象你是一家餐厅的**服务�?*�?
```
┌─────────────────────────────────────────────────────�?�?              输入处理 = 服务员的工作                  �?�?                                                     �?�?  顾客（玩家）发出需求：                               �?�?  - "我要一份牛�? �?顾客�?E 打开菜单                 �?�?  - "我要喝水" �?顾客�?F 喝手中的�?                   �?�?  - "我要离开" �?顾客�?Esc 退�?                      �?�?                                                     �?�?  服务员（输入系统）需要：                              �?�?  1. 听懂顾客的需求（监听按键/鼠标�?                   �?�?  2. 记住顾客点了什么（记录按键状态）                   �?�?  3. 把需求传给厨房（通知游戏逻辑�?                    �?�?  4. 给顾客反馈（显示界面变化�?                       �?└─────────────────────────────────────────────────────�?```
...
```
┌─────────────────────────────────────────────────────�?�?             Keyboard 输入处理流程                    �?�?                                                     �?�? 1. 【初始化�?                                      �?�?    keyboard.setup(windowHandle)                     �?�?    �?                                               �?�?    向窗口注册键盘回�?                               �?�?                                                     �?�? 2. 【事件触发�?                                     �?�?    用户按下键盘 �?GLFW 发送事�?                      �?�?    �?                                               �?�?                                                     �?�? 3. 【事件处理�?                                     �?�?    onKeyEvent(keyCode, scanCode, action, mods)      �?�?    �?                                               �?�?                                                     �?�? 4. 【分发处理�?                                     �?�?    ┌────────────┬────────────�?                      �?�?    �?           �?           �?                      �?�? 聊天界面?   游戏菜单�?  游戏内？                      �?�? (ChatScreen)  (PauseScreen)  (World)                �?�?                                                     �?�? 5. 【快捷键检查�?                                   �?�?    KeyBinding.setKeyPressed(key, true)              �?└─────────────────────────────────────────────────────�?```

### Mouse �?
`Mouse.java` 负责监听鼠标事件�?
```
┌─────────────────────────────────────────────────────�?�?             Mouse 输入处理流程                       �?�?                                                     �?�? 【鼠标按钮�?                                        �?�? ┌─────────┬─────────┬─────────�?                    �?�? �?左键    �?中键    �?右键    �?                    �?�? �?攻击    �?望远�? �?使用    �?                    �?�? �?Button=0�?Button=1�?Button=2�?                    �?�? └─────────┴─────────┴─────────�?                    �?�?                                                     �?�? 【鼠标移动�?                                        �?�? - cursorDeltaX/Y: 鼠标移动�?                        �?�? - 用于旋转视角（第一/第三人称�?                      �?�?                                                     �?�? 【滚轮�?                                           �?�? - eventDeltaVerticalWheel: 垂直滚动�?               �?�? - 用于切换快捷栏物�?                                 �?�?                                                     �?�? 【特殊处理�?                                        �?�? - Mac系统: Ctrl+左键 = 右键                          �?�? - 触屏模式: 模拟鼠标输入                              �?└─────────────────────────────────────────────────────�?```

### KeyBinding 快捷键绑�?
`KeyBinding` �?Minecraft 的快捷键系统，让玩家可以自定义按键：

```
┌─────────────────────────────────────────────────────�?�?           KeyBinding 快捷键系�?                     �?�?                                                     �?�? 【按键分类�?                                        �?�? ┌──────────────────────────────────────────────�? �?�? �?MOVEMENT_CATEGORY (移动)                       �? �?�? �?- 前进: W                                      �? �?�? �?- 后退: S                                      �? �?�? �?- 左移: A                                      �? �?�? �?- 右移: D                                      �? �?�? �?- 跳跃: 空格                                    �? �?�? �?- 潜行: 左Shift                                  �? �?�? └──────────────────────────────────────────────�? �?�?                                                     �?�? ┌──────────────────────────────────────────────�? �?�? �?GAMEPLAY_CATEGORY (游戏操作)                   �? �?�? �?- 攻击/破坏: 鼠标左键                           �? �?�? �?- 使用物品: 鼠标右键                            �? �?�? �?- 丢弃物品: Q                                  �? �?�? �?- 物品�? E                                    �? �?�? └──────────────────────────────────────────────�? �?�?                                                     �?�? 【按键状态�?                                        �?�? ┌──────────────────────────────────────────────�? �?�? �?isPressed(): 按键是否正在被按�?                �? �?�? �?wasPressed(): 按键是否刚刚被按下（消费一次）     �? �?�? �?timesPressed: 记录按键被按了多少次              �? �?�? └──────────────────────────────────────────────�? �?└─────────────────────────────────────────────────────�?```

### 客户端预测（Client Prediction�?
网络延迟就像打电话时的延迟：

```
┌─────────────────────────────────────────────────────�?�?          客户端预�?= 减少"电话延迟"的感�?            �?�?                                                     �?�? 【没有预测的情况�?                                  �?�? 玩家�?W �?等待服务器确�?�?角色才移�?               �?�?          �?                                         �?�?    (延迟200ms = 卡顿明显)                            �?�?                                                     �?�? 【有预测的情况�?                                    �?�? 玩家�?W �?客户端立即移�?�?同时发送数据包              �?�?          �?                                         �?�?    (感觉是即时响�?                                  �?�?          �?                                         �?�?    服务器确�?修正                                    �?�?          �?                                         �?�?    如果预测错误，进�?回滚"                            �?└─────────────────────────────────────────────────────�?```
...
sequenceDiagram
    participant P as 玩家
    participant C as 客户�?    participant N as 网络
    participant S as 服务�?    participant W as 世界

    Note over P,S: 玩家向前移动的场�?
    P->>C: �?W �?    C->>C: 本地预测：移动玩�?+2�?    C->>C: 渲染新位�?    Note right of C: 玩家立即看到移动

    C->>N: 发�?PlayerMoveC2SPacket
    N->>S: 网络传输

    S->>W: 验证移动请求
    S->>W: 物理碰撞检�?    S->>W: 实际移动 +1.8格（可能有差异）

    alt 预测正确
        S->>S: 移动有效
        S->>N: 发送确�?        N->>C: 同步状态（差异很小�?        C->>C: 微调位置
    else 预测错误
        S->>S: 移动被阻�?        S->>N: 发送修正位�?        N->>C: 强制回滚到服务器位置
        C->>C: 回滚玩家位置
    ...
    private void onKey(long window, int key, int scanCode, int action, int modifiers) {
        if (action == GLFW.GLFW_PRESS) {
            ...
            if (key == GLFW.GLFW_KEY_ESCAPE) {
                // ESC �?- 关闭界面或暂�?                this.client.scheduleStop();
...
public class Mouse {
    ...
    // 更新视角（每tick�?    private void updateMouse(double timeDelta) {
        // 鼠标灵敏度设�?        double sensitivity = this.client.options.getMouseSensitivity().getValue();
...
public class KeyBinding implements Comparable<KeyBinding> {
    // 所有按键绑�?    private static final Map<String, KeyBinding> KEYS_BY_ID = Maps.newHashMap();
    // 按键到绑定的映射
    private static final Map<InputUtil.Key, KeyBinding> KEY_TO_BINDINGS = Maps.newHashMap();
    
    // 按键状�?    private InputUtil.Key boundKey;
    private boolean pressed;
    private int timesPressed;  // 按下次数（用�?wasPressed�?    
    // 创建一个新的快捷键
    ...
    // 按键是否正在被按�?    public boolean isPressed() {
        return this.pressed;
    }
    ...
    // 每tick更新按键状�?    public static void updatePressedStates() {
...
public class KeyboardInput extends Input {
    ...
    public void tick(boolean slowDown, float slowDownFactor) {
        // 检测按键状�?        this.pressingForward = this.settings.forwardKey.isPressed();
        ...
        // 跳跃和潜�?        this.jumping = this.settings.jumpKey.isPressed();
...
3. **计算移动向量**
   ...
   Vec3d input = new Vec3d(
       this.input.sideways,  // A/D 的�?       0,                    // Y 轴（跳跃分开处理�?       this.input.forward    // W/S 的�?   );
   ```

4. **本地预测移动**
   ```java
   // ClientPlayerEntity.move()
   // 先在客户端模拟移�?   Vec3d newPos = this.pos.add(input.multiply(speed));
   ```
...
1. **输入处理** = 把玩家的按键/鼠标操作转换成游戏动�?2. **Keyboard** = 负责监听键盘事件（按下、释放）
3. **Mouse** = 负责监听鼠标事件（移动、点击、滚轮）
4. **KeyBinding** = 管理可自定义的快捷键，支持查询按键状�?5. **客户端预�?* = 在收到服务器确认前本地模拟操作，减少延迟�?
## 练习

1. 在源码中找到 `Keyboard.java`，阅读按键处理方�?2. 在源码中找到 `Mouse.java`，了解鼠标移动如何影响视�?3. 查看 `KeyBinding.java`，理�?`isPressed()` �?`wasPressed()` 的区�?4. 思考：为什么需要区�?按住"�?刚按�?两种状态？

## 相关链接

- Part-9：[GUI系统](./47-gui-system.md) - 界面与输入的交互
- Part-9：[Minecraft客户端核心](./45-minecraft-client.md)
- Part-6 网络：[网络同步](/mc/1.21/tutorials/Part-6-Network/36-sync-mechanism/) - 了解预测与同�?
---
...
| 文件 | 源码路径 | 说明 |
|------|----------|------|
| ClientPlayerEntity.java | `net/minecraft/client/network/ClientPlayerEntity.java` | 客户端玩家实体，处理输入和预�?|
| Keyboard.java | `net/minecraft/client/keyboard/Keyboard.java` | 键盘输入处理 |
| Mouse.java | `net/minecraft/client/mouse/Mouse.java` | 鼠标输入处理 |
| KeyBinding.java | `net/minecraft/client/option/KeyBinding.java` | 快捷键绑定系�?|

---

**关键�?*：Input、Keyboard、Mouse、KeyBinding、GLFW、Client Prediction
